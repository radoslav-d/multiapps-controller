...
class FlowableActionFactoryTest {
    ...
    void testAbortAction() {
        Mockito.when(processActionRegistry.getAction(ABORT_ACTION_ID))
               .thenReturn(new AbortProcessAction(facade, List.of(additionalProcessAction), null, operationService, cloudControllerClientProvider, null, null));
    ...
    void testResumeAction() {
        Mockito.when(processActionRegistry.getAction(RESUME_ACTION_ID))
               .thenReturn(new ResumeProcessAction(facade, List.of(additionalProcessAction), cloudControllerClientProvider, operationService));
